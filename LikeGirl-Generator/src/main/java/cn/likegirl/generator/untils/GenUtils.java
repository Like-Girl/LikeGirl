package cn.likegirl.generator.untils;


import cn.likegirl.common.core.util.DateUtil;
import cn.likegirl.generator.domain.ColumnDO;
import cn.likegirl.generator.domain.TableDO;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        map.put("datetime", DateUtil.format(new Date(), DateUtil.DATE_PATTERN.YYYY_MM_DD_HH_MM_SS));
